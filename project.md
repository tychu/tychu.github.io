...
This master's thesis is conducted within [IMEC](https://www.imec-int.com/en) (an international research & development organization, active in the fields of nanoelectronics and digital technologies with headquarters in Belgium). This thesis investigates **end-to-end deep learning models for radar-based object detection**, focusing on directly processing raw Analog-to-Digital Converter (ADC) data. The research compares this approach to traditional methods using pre-processed radar data, such as Range-Doppler maps. Several **novel model architectures are proposed and evaluated**, including Extended T-FFTRadNet and ADAT-FFTRadNet, which incorporate advanced techniques like Swin Transformers and adaptive-directional attention. 
...
## Seminar: Literature review on End-to-End ASR LM integration
